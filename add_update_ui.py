# C:\project-expense-tracking-system\frontend\add_update_ui.py
...
def add_update_tab():
    ...
    categories= ["Rent","Food","shopping","Bills","Entertainment","Transport","other"]
    with st.form(key="expense_form"):
        ...
        for i in range(5):
            ...
            with col1:
                ...
                amount_input=st.number_input(label="Amount",min_value=0.0,step=0.0,value=amount,key=f"amount_{i}",label_visibility="collapsed")
            with col2:
        ...
        if submit_button:
            ...
            if response.status_code==200:
                st.success("Expenses Updated Sucessfully")
            else:
